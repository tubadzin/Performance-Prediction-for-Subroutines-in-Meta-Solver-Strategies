        ...
        if features_in_db
            if mip
                ...
                if 0
                    ...
                    cmd = strcat([cmd, ' from ', feature_table, ' where INSTANCE_ID = ', num2str(id)]);
                    [tmp(1), tmp(2), tmp(3), tmp(4), tmp(5), tmp(6), tmp(7), tmp(8), tmp(9), tmp(10), tmp(11), tmp(12), tmp(13), tmp(14), tmp(15), tmp(16), tmp(17), tmp(18), tmp(19), tmp(20), tmp(21), tmp(22), tmp(23), tmp(24), tmp(25), tmp(26), tmp(27), tmp(28), tmp(29), tmp(30), tmp(31), tmp(32), tmp(33), tmp(34), tmp(35), tmp(36), tmp(37), tmp(38), tmp(39), tmp(40), tmp(41), tmp(42), tmp(43), tmp(44), tmp(45), tmp(46), tmp(47), tmp(48), tmp(49), tmp(50), tmp(51), tmp(52), tmp(53), tmp(54), tmp(55), tmp(56), tmp(57), tmp(58), tmp(59), tmp(60), tmp(61), tmp(62), tmp(63), tmp(64), tmp(65), tmp(66), tmp(67), tmp(68), tmp(69), tmp(70), tmp(71), tmp(72), tmp(73), tmp(74), tmp(75), tmp(76), tmp(77), tmp(78), tmp(79), tmp(80), tmp(81), tmp(82), tmp(83), tmp(84), tmp(85), tmp(86), tmp(87), tmp(88), tmp(89), tmp(90), tmp(91), tmp(92), tmp(93), tmp(94), tmp(95), tmp(96), tmp(97), tmp(98), tmp(99), tmp(100), tmp(101), tmp(102), tmp(103), tmp(104), tmp(105), tmp(106), tmp(107), tmp(108), tmp(109), tmp(110), tmp(111), tmp(112), tmp(113), tmp(114), tmp(115), tmp(116), tmp(117), tmp(118), tmp(119), tmp(120), tmp(121), tmp(122), tmp(123), tmp(124), tmp(125)] = mysql(cmd);
                end
            end
            uniqX(i,:) = tmp;
            break
